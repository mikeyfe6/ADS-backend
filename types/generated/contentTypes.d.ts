...
export interface ApiInstantieInstantie extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::instantie.instantie': ApiInstantieInstantie;
